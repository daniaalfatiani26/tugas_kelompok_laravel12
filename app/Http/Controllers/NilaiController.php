...
class NilaiController extends Controller
{
   // 1. Menampilkan Halaman Utama (Tabel Laporan & Form Input)
    ...
    // 2. Memproses Penyimpanan Data Baru dari Form Kuning
    ...
    // 4. Memproses Perubahan Data (Update) ke Database
    public function update(Request $request, $id)
    {
        ...
        return redirect('/nilai')->with('sukses', 'Data nilai berhasil diubah!');
    }
