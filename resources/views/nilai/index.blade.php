...
<div class="container mt-5">
    ...
    <a href="/nilai/{{ $data->id }}/edit" class="btn-edit" style="background-color: #007bff; color: white; padding: 6px 12px; text-decoration: none; border-radius: 4px; margin-right: 5px; font-size: 14px;">Edit</a>

   <form action="{{ route('nilai.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data?')">
        @csrf
        @method('DELETE')
        <button type="submit" class="btn-hapus" style="background-color: #dc3545; ...">Hapus</button>
    </form>
</td>
                                    </tr>
                                @empty
